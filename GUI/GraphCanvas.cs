...
namespace GUI
{
    ...
    {
        private CanvasController _cavasController;
        ...
        private void GraphGUI_Load(object sender, EventArgs e)
        {
            ...
            _cavasController = new CanvasController(canvas);
        ...
        private void DrawPanel_MouseDown(object sender, MouseEventArgs e)
        {
            if (drawRadioButton.Checked)
                _cavasController.Add(e.X, e.Y);
            if (selectRadioButton.Checked)
                _cavasController.SelectTerminal(e.X, e.Y);
        ...
        {
            _cavasController.ResetEdges();
            _canvasView.Render();
        }

        private void ClearButton_Click(object sender, EventArgs e)
        {
            _cavasController.Clear();
            _canvasView.Render();
        }
